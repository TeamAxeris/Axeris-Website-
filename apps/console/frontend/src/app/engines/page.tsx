  ...
  return (
    <div className="space-y-5">
      ...
      <InsightPanel title="Signals appearing most often" description="A quick view of what is driving review volume on this book.">
        ...
        <div className="mt-3 text-right"><Link href="/checks" className="text-[12px] font-medium text-blue-600 dark:text-blue-400 inline-flex items-center gap-1">Review all coverage checks <ArrowRight className="w-3.5 h-3.5" /></Link></div>
      </InsightPanel>
    </div>
  );
}
