                ...
                <tbody>
                  {fraud.flagged_prescribers.map((fp) => (
                    <tr key={fp.provider_id} className="border-b border-gray-50">
                      <td className="py-2">
                        <Link href={`/providers/${fp.provider_id}`} className="text-sm text-blue-600 hover:underline dark:text-blue-400">
                          {fp.provider_name}
                        </Link>
                      </td>
                ...
                <tbody>
                  {fraud.doctor_shopping_patients.map((ds) => (
                    <tr key={ds.patient_id} className="border-b border-gray-50">
                      <td className="py-2">
                        <Link href={`/patients/${ds.patient_id}`} className="text-sm text-blue-600 hover:underline dark:text-blue-400">
                          {ds.patient_name}
                        </Link>
                      </td>
