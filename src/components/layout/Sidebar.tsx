...
const TPA_SECTIONS: NavSection[] = [
  {
    label: "Workflow",
    items: [
      { href: "/console/tpa/dashboard", label: "Dashboard", icon: LayoutDashboard },
      { href: "/console/tpa/pend-queue", label: "Pend Queue", icon: ClipboardList },
      { href: "/console/tpa/asa-disputes", label: "Disputes", icon: Scale },
      { href: "/console/tpa/fraud-referrals", label: "Fraud & Abuse", icon: AlertOctagon },
    ],
  },
  {
  ...
  },
  {
    label: "Plan Sponsors",
    items: [
      { href: "/console/tpa/employer-reports", label: "Employers", icon: Building2 },
      { href: "/console/tpa/stewardship", label: "Stewardship Reports", icon: FileText },
    ],
  },
  {
    label: "Records",
    items: [
      { href: "/console/prescriptions", label: "Claims", icon: Pill },
      { href: "/console/patients", label: "Members", icon: Users },
      { href: "/console/providers", label: "Prescribers", icon: Stethoscope },
    ],
  },
  {
    label: "Admin",
    items: [
      { href: "/console/engines", label: "AI Engines", icon: Cpu },
      { href: "/console/data-sources", label: "Data Sources", icon: Database },
      { href: "/console/audit", label: "Audit Trail", icon: ClipboardList },
...
const PBA_SECTIONS: NavSection[] = [
  {
    label: "Adjudication",
    items: [
      { href: "/console/pba/dashboard", label: "Dashboard", icon: LayoutDashboard },
      { href: "/console/pba/live-transactions", label: "Live Transactions", icon: Radio },
      { href: "/console/pba/ncpdp-rejects", label: "Pre-Dispense Stops", icon: AlertOctagon },
      { href: "/console/pba/callbacks", label: "Pharmacist Callbacks", icon: Phone },
    ],
  },
  {
    label: "Value",
    items: [
      { href: "/console/pba/savings", label: "Savings Opportunities", icon: TrendingUp },
      { href: "/console/pba/split-fill", label: "Split Fill", icon: Scissors },
      { href: "/console/pba/site-of-care", label: "Site of Care", icon: Home },
      { href: "/console/pba/mail-order", label: "Mail Order", icon: Truck },
    ],
  },
  {
    label: "Network",
    items: [
      { href: "/console/pba/pharmacy-network", label: "Pharmacy Network", icon: Network },
      { href: "/console/pba/formulary-mgmt", label: "Formulary", icon: Layers },
    ],
  },
  {
    label: "Members",
    items: [
      { href: "/console/patients", label: "Members", icon: Users },
      { href: "/console/pba/member-safety", label: "Member Safety", icon: HeartPulse },
      { href: "/console/providers", label: "Prescribers", icon: Stethoscope },
      { href: "/console/prescriptions", label: "Claims", icon: Pill },
    ],
  },
  {
    ...
    items: [
      { href: "/console/engines", label: "AI Engines", icon: Cpu },
      { href: "/console/data-sources", label: "Data Sources", icon: Database },
      { href: "/console/audit", label: "Adjudication Log", icon: ClipboardList },
      { href: "/console/settings", label: "Settings", icon: Settings },
    ],
  },
];
