            ...
            {pgxData.length === 0 ? (
              ...
              <div key={row.patient_id} className="bg-white dark:bg-gray-800 rounded-lg border border-purple-200 dark:border-purple-800 p-4">
                <div className="flex items-center justify-between mb-3">
                  <Link href={`/console/patients/${row.patient_id}`} className="text-base font-semibold text-purple-700 dark:text-purple-300 hover:underline">
          ...
          <div className="space-y-3">
            {remsData.length === 0 ? (
              ...
              <div key={row.patient_id} className="bg-white dark:bg-gray-800 rounded-lg border border-rose-200 dark:border-rose-800 p-4">
                <div className="flex items-center justify-between mb-3">
                  <Link href={`/console/patients/${row.patient_id}`} className="text-base font-semibold text-rose-700 dark:text-rose-300 hover:underline">
                    {row.patient_name} ({row.patient_id})
                  </Link>
                </div>
