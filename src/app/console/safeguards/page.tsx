...
export default function SafeguardsPage() {
  ...
  return (
    <div className="p-6 max-w-[1200px] space-y-5">
      <Link href="/console/tpa/dashboard" className="inline-flex items-center gap-1 text-[12px] text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200">
